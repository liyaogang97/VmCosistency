...
def kernel_prediction():
    ...
    #         kernel_recording['memory_count']) + " and server_type=" + str(kernel_recording['server_type'])
    ...
    np_list_regressor_data = np.load("E:\\PyCharm-workspace\\VmCosistency\\src\\random_forest_regressor\\kernel\\np_list_regressor_data.npy")
    ...
    train, test, train_data_target, test_data_target = train_test_split(np_list_regressor_data, labels, test_size=0.9)
