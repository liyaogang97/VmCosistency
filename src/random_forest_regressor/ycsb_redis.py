...
for ycsb_redis_recording in ycsb_redis_recordings:
    ...
    stream_select_sql = "select * from stream where cpu_number=" + str(
        ...
        ycsb_redis_recording['memory_count']) + " and server_type=" + str(ycsb_redis_recording['type'])
    ...
    fio_read_select_sql = "select * from fio_read where cpu_number=" + str(
        ycsb_redis_recording['cpu_number']) + " and cpu_frequency=" + str(
        ycsb_redis_recording['cpu_frequency']) + " and memory_count=" + str(
        ycsb_redis_recording['memory_count']) + " and type=" + str(ycsb_redis_recording['type'])
...
for regressor_data in list_regressor_data:
    ...
    if data[0] == "6230":
        ...
        train_data_target.append(float(data[target_col]))
    else:
        test_data.append(data)
        test_data_target.append(float(data[target_col]))
